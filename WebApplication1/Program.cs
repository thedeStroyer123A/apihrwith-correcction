...
builder.Services.AddCors(options =>
{
    options.AddPolicy(name: MyAllowSpecificOrigins,
        policy =>
        {
            //policy.WithOrigins("https://localhost:7283", "https://localhost:7283").WithMethods("PUT", "DELETE", "GET","POST");
            policy.WithOrigins("https://localhost:7283", "https://localhost:7283").AllowAnyHeader().AllowAnyMethod();
        });
});
